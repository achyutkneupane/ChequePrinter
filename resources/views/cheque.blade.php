...
{{--    payee --}}
    <div style="position: absolute; top: calc(88.9mm - 71.5mm); left: 38mm;">
        <table>
            <tr style="color: red; height: 9.525mm;">
...
{{--    amount --}}
    <div style="position: absolute; top: calc(88.9mm - 60.33mm + 0.7875mm); left: calc(190.5mm - 53.975mm + 1.5875mm);">
        <table>
            <tr style="color: red; height: 9.525mm;">
                <td>10,000</td>
            </tr>
...
{{--    amount in words --}}
    <div style="position: absolute; top: calc(88.9mm - 63.5mm); right: 66.675mm; left: 20mm;">
        <table>
            <tr style="color: red;">
                <td>ten thousand only</td>
            </tr>
            <tr style="position: absolute; color: red; top: 6.35mm;">
                <td></td>
            </tr>
        </table>
    </div>
